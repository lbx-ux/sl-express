...
public class CarriageUtils {
    ...
    public static CarriageEntity toEntity(CarriageDTO carriageDTO) {
        CarriageEntity carriage = BeanUtil.copyProperties(carriageDTO, CarriageEntity.class);
        //关联城市以逗号分割存储到数据库
    ...
    public static CarriageDTO toDTO(CarriageEntity carriage) {
        CarriageDTO carriageDTO = BeanUtil.copyProperties(carriage, CarriageDTO.class);
        //按照逗号分割成集合放入DTO对象中
